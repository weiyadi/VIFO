# Modified from https://github.com/izmailovpavel/understandingbdl/blob/master/swag/posteriors/swag.py.
import torch

from posteriors.posteriors_utils import flatten, set_weights
...
class SWAG(torch.nn.Module):
    ...
    def __init__(self, base, subspace_type,
        ...
        [param.requires_grad_(False) for param in self.base_model.parameters()]
