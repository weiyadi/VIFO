# Modified from https://github.com/izmailovpavel/understandingbdl/blob/master/swag/posteriors/subspaces.py.
"""
    subspace classes
...
class CovarianceSpace(Subspace):
    ...
    def get_space(self):
        if self.cov_mat_sqrt.size(0) == 1:
            return self.cov_mat_sqrt.clone() / (self.cov_mat_sqrt.size(0)) ** 0.5
